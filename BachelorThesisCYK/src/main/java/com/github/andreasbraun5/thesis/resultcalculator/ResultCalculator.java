    ...
    private Map<String, List<ResultSample>> createChunkResults(
        ...
        for (int i = 0; i < countDifferentWords && countSamplesGenerated < CHUNK_SIZE; i++) {
            ...
            GrammarWordMatrixWrapper grammarWordMatrixWrapper = GrammarWordMatrixWrapper.buildGrammarWordMatrixWrapper().
                    setWord(WordGeneratorDiceRoll.generateWordAsTerminalList(tempGrammarProperties));
            String tempWord = grammarWordMatrixWrapper.getWord().toString();
            ...
            for (int j = 0; j < countOfGrammarsToGeneratePerWord && countSamplesGenerated < CHUNK_SIZE; j++) {
                ...
                GrammarWordMatrixWrapper.buildGrammarWordMatrixWrapper().setWord(Util.stringToTerminalList(tempWord));
