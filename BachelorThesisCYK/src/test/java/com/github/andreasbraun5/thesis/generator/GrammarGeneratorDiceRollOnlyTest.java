...
public class GrammarGeneratorDiceRollOnlyTest {
	...
	public void generateGrammar() {
		System.out.println( "" );
		System.out.println( "############################" );
		System.out.println( "ResultCalculator GrammarGeneratorDiceRollOnly: generateGrammar" );
		...
		GrammarGeneratorSettingsDiceRoll generatorGrammarDiceRollSettings = new GrammarGeneratorSettingsDiceRoll( grammarProperties);
		...
		// TODO: useless ResultCalculator now... still reasonable?
