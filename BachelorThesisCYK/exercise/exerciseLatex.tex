...
\begin{document}
\begin{center} 
\begin{tabular}{l}$A\rightarrow N,S'~|~E,C~|~0~~$\\ 
$B\rightarrow N,D~|~E,S'~|~1~~$\\ 
$S\rightarrow N,B~|~eps~|~E,A~~$\\ 
$C\rightarrow A,A~~$\\ 
$S'\rightarrow N,B~|~E,A~~$\\ 
$D\rightarrow B,B~~$\\ 
$E\rightarrow 1~~$\\ 
$N\rightarrow 0~~$\\ 
\end{tabular} 
...
\node [] at (center34) {\myfontvars{C$_5$C$_7$}};
%cells40
