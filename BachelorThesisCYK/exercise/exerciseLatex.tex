...
\node [] at (center12) {\myfontvars{C$_{3}$}};
%cells13
...
\node [] at (center15) {\myfontvars{C$_{6}$}};
%cells16
...
\node [] at (center18) {\myfontvars{C$_{9}$}};
%cells20
...
\node [] at (center21) {\myfontvars{C$_{2}$A$_{3}$}};
%cells22
...
\node [] at (center40) {\myfontvars{C$_{1}$C$_{4}$A$_{4}$}};
%cells41
...
\node [] at (center50) {\myfontvars{S$_{5}$}};
%cells51
...
\node [] at (center60) {\myfontvars{C$_{5}$A$_{6}$}};
%cells61
...
\node [] at (center70) {\myfontvars{S$_{7}$}};
%cells71
...
\node [] at (center90) {\myfontvars{S$_{7}$C$_{7}$A$_{8}$}};
\end{tikzpicture}
}
\end{center}
\begin{center}
