...
\node [] at (center04) {\myfontvars{C$_{5}$}};
%cells05
...
\node [] at (center15) {\myfontvars{S$_{6}$}};
%cells16
...
\node [] at (center17) {\myfontvars{S$_{8}$}};
%cells18
...
\node [] at (center20) {\myfontvars{C$_{2}$}};
%cells21
...
\node [] at (center33) {\myfontvars{S$_{6}$}};
%cells34
...
\node [] at (center41) {\myfontvars{C$_{5}$}};
%cells42
...
\node [] at (center54) {\myfontvars{A$_{5}$}};
%cells60
...
\node [] at (center63) {\myfontvars{B$_{4}$C$_{7}$}};
%cells70
...
\node [] at (center72) {\myfontvars{S$_{3}$A$_{3}$}};
%cells80
...
\node [] at (center81) {\myfontvars{C$_{5}$C$_{7}$}};
%cells90
\coordinate (center90) at (5.0,-4.5);
\node [below=0.18cm] at (center90) {\myfontnumbering{$(90)$}};
\node [] at (center90) {\myfontvars{A$_{1}$S$_{3}$A$_{3}$}};
\end{tikzpicture}
}
\end{center}
\begin{center}
