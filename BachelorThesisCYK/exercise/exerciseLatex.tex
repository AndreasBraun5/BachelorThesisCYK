...
\begin{document}
\begin{center} 
\begin{tabular}{l}$A\rightarrow C C~~$\\ 
$B\rightarrow C C~~$\\ 
$C\rightarrow b~|~B C~|~a~~$\\ 
$S\rightarrow A C~~$\\ 
\end{tabular} 
\end{center}
\begin{center}
