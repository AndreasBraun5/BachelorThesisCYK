...
\begin{document}
\begin{center} 
\begin{tabular}{l}$A\rightarrow B C~|~S S~~$\\ 
$B\rightarrow a~~$\\ 
$S\rightarrow b~|~S A~|~B S~~$\\ 
$C\rightarrow S C~|~B B~~$\\ 
\end{tabular} 
\end{center}
\begin{center}
\resizebox{\linewidth}{!}{
...
\coordinate (dr1) at (5.0,-4.0);
\coordinate (dr2) at (5.5,-3.5);
\coordinate (dr3) at (6.0,-3.0);
\coordinate (dr4) at (6.5,-2.5);
\coordinate (dr5) at (7.0,-2.0);
\coordinate (dr6) at (7.5,-1.5);
\coordinate (dr7) at (8.0,-1.0);
\coordinate (dr8) at (8.5,-0.5);
\draw (dr1) -- (1,0);
\draw (dr2) -- (2,0);
\draw (dr3) -- (3,0);
\draw (dr4) -- (4,0);
...
\node [] at (center02) {\myfontvars{B$_{3}$}};
%cells03
...
\node [] at (center13) {\myfontvars{S$_{4}$}};
%cells14
...
\node [] at (center22) {\myfontvars{S$_{3}$}};
%cells23
...
\node [] at (center33) {\myfontvars{A$_{5}$}};
%cells34
