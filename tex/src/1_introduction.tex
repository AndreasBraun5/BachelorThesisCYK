...
During the execution of the CYK algorithm the parsing table is filled as shown in Figure \ref{exampleCYK}. An example output of this definition of the CYK could look like this:
\noindent
\begin{figure} [h]
	\begin{minipage}{6in}
		\centering
