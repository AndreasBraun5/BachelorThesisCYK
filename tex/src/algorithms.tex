...
\begin{center}
	...
	\coordinate (center01) at (1.5,-0.433);
	\coordinate (center02) at (2.5,-0.433);
	\coordinate (center03) at (3.5,-0.433);
	\coordinate (center04) at (4.5,-0.433);
	\coordinate (center05) at (5.5,-0.433);
	\coordinate (center10) at (1.0,-0.866);
	\node [] at (center10) {\fontsize{5}{12}\selectfont{S1}};
	\node [left] at (center10) {\fontsize{5}{12}\selectfont{B1}};
	\coordinate (center11) at (2.0,-0.866);
	\node [] at (center11) {\fontsize{5}{12}\selectfont{B2}};
	\node [left] at (center11) {\fontsize{5}{12}\selectfont{A2}};
	\coordinate (center12) at (3.0,-0.866);
	\coordinate (center13) at (4.0,-0.866);
	\coordinate (center14) at (5.0,-0.866);
	\coordinate (center20) at (1.5,-1.299);
	\coordinate (center21) at (2.5,-1.299);
	\node [] at (center21) {\fontsize{5}{12}\selectfont{S2}};
	\coordinate (center22) at (3.5,-1.299);
	\node [] at (center22) {\fontsize{5}{12}\selectfont{A3}};
	\coordinate (center23) at (4.5,-1.299);
	\coordinate (center30) at (2.0,-1.732);
	...
	\coordinate (center31) at (3.0,-1.732);
