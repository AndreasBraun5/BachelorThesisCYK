...
\subsubsection{Alg: GeneratorGrammarDiceRollOnly}
...
\pagebreak
\subsubsection{Alg: BottomUp GeneratorGrammarDiceRollMartens1}
...
\pagebreak
\subsubsection{Alg: BottomUp GeneratorGrammarDiceRollMartens2}
\noindent
\frame{
	\begin{algorithm}[H] %or another one check
...
\pagebreak 
\subsubsection{Alg: TopDown From node to leaves}
\subsubsection{Alg: How often cells are used for subset calculations}
