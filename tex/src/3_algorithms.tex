...
\begin{figure} [h]
	...
	\end{minipage}
	\caption{Illustration of Algorithm \ref{SplitThenFill} part 4.}
...
\begin{figure} [h]
	...
	\end{minipage}
	\caption{Illustration of Algorithm \ref{SplitThenFill} part 5: After adding rule $C\rightarrow BC$.}
...
\begin{figure} [h]
	\begin{minipage}{6in}
		\centering
		\begin{tabular}{l}$A\rightarrow B S~|~a~~$\\ 
			$B\rightarrow b~|~C B~~$\\ 
			$C\rightarrow c~|~B C~~$\\ 
	...
	\end{minipage}
	\caption{Illustration of Algorithm \ref{SplitThenFill} part 5: After adding rule $S\rightarrow AC$.}
	\label{IllustrationAlgorithmSplitThenFillPart5}
\end{figure}\\
