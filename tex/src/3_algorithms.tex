...
\frame{
	\begin{algorithm}[H] %or another one check
		...
		Für beide Zellen:\;
			Checken ob i > 0\;
				i > 0: Hinzufügen einer Var in die Zelle\;
				i = 0: Checken ob Terminal wj schon vergeben\;
					ja: dann nutzen der Var bzw. des lhse der Prod des wj\;
					nein: Würfeln von Var und Hinzufügen der Prod Var --> wj\;
		Hinzufügen der Produktion mit VarComp = (Var1, Var2) zur Variablen der aufrufenden Zelle\;
		\If{$i=0$}{
