...
\begin{figure} [h]
	...
	\end{minipage}
	\caption{Illustration of Algorithm \ref{SplitAndFill} part 5. Finally to fill the cell in the tip a rule must be added that has the start variable as its $lhse$. Here the rule $S\rightarrow CA$ is added.}
