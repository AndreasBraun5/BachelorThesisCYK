...
To be able to find suitable exercises that can be displayed in area 3 of the tool a scoring is needed. The exercises are given a score according to Table \ref{scoring}. Parameters that influence the score are:
\begin{itemize}
