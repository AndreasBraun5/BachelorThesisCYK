...
The first step here is the tokenization of the input in token as seen in Figure \ref{antlrGrammarTokens} on the right. After that with the help of the Grammar as seen in Figure \ref{antlrGrammarRules} an abstract syntax tree is generated out of which intern Java objects can be parsed.\\
\noindent
\begin{figure} [h]
	\centering
