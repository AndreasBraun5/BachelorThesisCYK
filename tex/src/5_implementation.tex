...
\noindent Does the output $P \subseteq V \times (V^{2} \cup \Sigma)$ imply that $G$ is in oCNF? CNF does only have useful variables [TI script Def. 8.3 page 210] vs. $P \subseteq V \times (V^{2} \cup \Sigma)$.\\
