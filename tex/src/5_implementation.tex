...
\resizebox{0.43\linewidth}{!}{
	...
	\end{minipage}
	\captionof{figure}{Example output for a $exercise$. Top: Context free grammar. Middle: A $pyramid$ filled after the CYK algorithm. Bottom: Exemplary random derivation tree.}
